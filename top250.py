import argparse
from htmlParsers.top250Scraper import get_top_250_narrative_films
from fileWriters.csvWriter import write_to_csv
from fileWriters.txtWriter import write_to_txt

desc_message = "Collect info from letterboxd's Top 250 Narrative Features list to a .csv to .txt file " \
...
info = get_top_250_narrative_films()
content = "Top250NarrativeFilms"
